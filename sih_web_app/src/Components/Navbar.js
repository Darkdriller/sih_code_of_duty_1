...
function Navbar() {
  return (  
    ...
    <Link viewBox="0 0 248 31" class="text-slate-900 dark:text-white w-auto h-5" to="/">
            Shyam Prasad Mukherji Rurban Mission
    </Link>
    ...
    <li>
    <a class="hover:text-sky-500 dark:hover:text-sky-400" href="/map">
    Maps</a>
    </li>
    <li>
    ...
    <li>
    <a class="hover:text-sky-500 dark:hover:text-sky-400" href="/l eaderboard">
    Leaderboard</a>
    </li>
    <li>
    <a class="hover:text-sky-500 dark:hover:text-sky-400" href="https://jobs.tailwindcss.com/?ref=top">
    Jobs<span class="ml-2 font-medium text-xs leading-5 rounded-full text-sky-600 bg-sky-400/10 px-2 py-0.5  dark:text-sky-400">
    New</span>
    </a>
    </li>
    </ul>
